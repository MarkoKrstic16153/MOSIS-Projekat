...
public class MyTokensData {
    ...
    private  static class SingletonHolder{
        private static final MyTokensData instance = new MyTokensData();
    }
    public static MyTokensData getInstance(){
        return  MyTokensData.SingletonHolder.instance;
    }
